          ...
          child: Column(
            children: <Widget>[
              Container(
                ...
                child: TextField(
                  decoration: InputDecoration(border: InputBorder.none, hintText: '+375123456789', hintStyle: TextStyle(color: Colors.grey[400]), errorText: register.errorMessage),
                  autofocus: true,
